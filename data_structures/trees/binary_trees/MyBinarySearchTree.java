package Leetcode.data_structures.trees.binary_trees;
  ...
  public void remove(int value) {
      ...
      while(current != null) {
          ...
          // (value == current.value, means if we found the value to be removed)
              ...
              //Option 1: NO RIGHT CHILD    //Child means child of current node
              if(current.right==null) {
                  // if parent is null means delete the root node
                  if(parentNode==null) {
